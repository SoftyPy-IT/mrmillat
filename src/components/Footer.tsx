  ...
  return (
    <footer className="px-4 divide-y  bg-blue-950 text-gray-100">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <a rel="noopener noreferrer" href="/articles">
                    Articles
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a rel="noopener noreferrer" href="gallery">
                    Gallery
                  </a>
                </li>
                <li>
                  <a rel="noopener noreferrer" href="/media">
                    Voice on Media
                  </a>
                </li>
              </ul>
              ...
              <ul className="space-y-1">
                <li>
                  <a rel="noopener noreferrer" href="#">
                    Phone No. <span>{contact?.phone}</span>
                  </a>
                </li>
                <li>
                  <a rel="noopener noreferrer" href="#">
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">
        © {new Date().getFullYear()} M. Rashiduzzaman Millat. All rights
        reserved.
      </div>
    </footer>
  );
