  ...
  return (
    ...
    >
      ...
      >
        ...
        {userImage && isReady && (
          <div
            className={`absolute bottom-3 sm:bottom-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#006a4e] via-[#007a5e] to-[#007a5e] text-white px-2 sm:px-5 py-2 sm:py-2.5 rounded-full text-[10px] sm:text-xs font-bold shadow-lg shadow-[#006a4e]/20 pointer-events-none transition-all duration-300 flex items-center gap-2 ${
              isDragging
