...
const PhotoCard = () => {
  ...
  return (
    <div className="bg-white">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20 mb-8 max-w-6xl w-full">
          {images.map((image: TPhotoCards, index: number) => (
            ...
            >
              ...
              <div
                ...
                className="w-full aspect-[4/5] md:aspect-video lg:aspect-[4/5] relative transition-transform duration-500 hover:scale-105"
              >
                <div
                ...
                <h1
                  className={`absolute left-5 text-lg font-semibold text-white transition-all duration-500 ${
                    isHover && imageId === image?._id
                      ...
                      : "bottom-[-40px] opacity-100 md:opacity-0"
                  }`}
                >
                  {image?.title}
                </h1>
