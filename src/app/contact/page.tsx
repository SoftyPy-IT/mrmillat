   ...
   <div>
		{
			!isLoading && 
			<div
			className='flex justify-center items-center bg-[url(/Images/bg-1.gif)] min-h-screen bg-center bg-no-repeat bg-cover my-auto'>
      <section
	    data-aos="zoom-in"
		  data-aos-duration="2500"	
			style={{backgroundImage:`url(${contact?.bgImageUrl as string})`}}
			className="py-6  text-white  bg-center bg-cover  md:h-[400px]">
